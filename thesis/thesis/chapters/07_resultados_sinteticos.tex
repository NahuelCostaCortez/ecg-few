...
El primer bloque de resultados evalúa si la CNN puede aprender la tarea en un entorno controlado. El conjunto sintético contiene 100 pacientes simulados y 300 imágenes, con tres derivaciones por paciente. La etiqueta positiva corresponde a la presencia simultánea de los hallazgos operativos que definen el patrón Brugada derivado en el simulador. Hay 20 pacientes positivos y 80 normales o incompletos.
...
Por ese motivo, el siguiente capítulo contrasta estos resultados con Brugada HUCA y mide explícitamente la brecha de dominio.
