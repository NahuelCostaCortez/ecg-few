...
El síndrome de Brugada es un síndrome arrítmico hereditario asociado a riesgo de fibrilación ventricular y muerte súbita. Su definición ha evolucionado a medida que se ha estudiado la especificidad de los patrones espontáneos y provocados. El elemento electrocardiográfico central es el patrón tipo 1, caracterizado por elevación descendente del segmento ST en derivaciones precordiales derechas y onda T negativa \cite{sieira2017,zeppenfeld2022}.

La guía europea de 2022 sitúa el patrón tipo 1 en V1 o V2 colocadas en espacios intercostales estándar o superiores \cite{zeppenfeld2022}. Esta colocación es relevante porque registrar V1 y V2 más arriba puede aumentar la sensibilidad para observar el patrón \cite{brugadadrugsdiagnostic}. Aun así, el trazado aislado no debe interpretarse fuera del circuito clínico: hay que valorar síntomas, antecedentes familiares, fiebre, fármacos, alteraciones electrolíticas y fenocopias.

Cuando existe sospecha clínica y el ECG basal no es diagnóstico, puede realizarse una prueba farmacológica con bloqueantes del canal de sodio, como ajmalina, flecainida, procainamida o pilsicainida según disponibilidad local. Esta prueba intenta desenmascarar un patrón tipo 1 en un entorno monitorizado. La literatura reciente advierte que no debe usarse como cribado indiscriminado: la especificidad no es perfecta, no existe un patrón oro absoluto independiente del propio ECG y la indicación depende de síntomas, historia familiar y trazado basal \cite{wilde2023scbt}. Por tanto, en este TFG una predicción positiva debe entenderse como señal de triaje que podría conducir a revisión especializada y, si procede, a esta vía diagnóstica, no como diagnóstico final.
