...
La disponibilidad de datos sintéticos permite estudiar una pregunta metodológica sin esperar a reunir una colección clínica extensa. En este trabajo el simulador actúa como un laboratorio controlado. Cada beat se construye a partir de componentes interpretables, se valida mediante reglas explícitas y se transforma en una imagen que puede entregarse tanto a una CNN como a un modelo de visión y lenguaje.
