...
Por este motivo, cada valor positivo de \(K\) se repite con tres semillas para cuantificar la variabilidad asociada a la selección de ejemplos. La evaluación distingue zero-shot, ICL estándar e ICL balanceado. Esta separación permite analizar si las demostraciones aportan señal y cómo afecta el equilibrio de clases a la relación entre sensibilidad y especificidad.
