...
La memoria se compila con XeLaTeX. Las figuras de resultados se generan en modo no interactivo, con el mismo estilo tipográfico usado en el documento. Las ejecuciones con PyTorch aplican las recomendaciones de reproducibilidad disponibles en su documentación oficial \cite{pytorchrepro}.
...
\begin{table}[H]
  ...
  \begin{tabularx}{0.94\textwidth}{p{4.4cm}X}
    ...
    Métodos & SSL, CORAL, MMD y DANN \cite{ganin2016} \\
