...
Las dependencias de redes convolucionales ya están declaradas como extra opcional del proyecto mediante PyTorch y Torchvision. El entorno de servicio vLLM se gestiona por separado porque la campaña VLM no forma parte de los resultados cerrados. Antes de incorporar esa línea será necesario registrar revisión de pesos, versión del servidor, plantilla de conversación y predicciones completas.
