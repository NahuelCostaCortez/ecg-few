...
En ICL estándar, el prompt incluye \(K\) demostraciones correctas tomadas del conjunto disponible. Cada demostración contiene una imagen de ECG y la respuesta JSON esperada. La selección no fuerza explícitamente la proporción entre positivos y negativos. Por tanto, refleja el contexto que aparece al seguir la estrategia estándar de muestreo del experimento.
