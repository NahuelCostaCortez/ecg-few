...
Estos resultados delimitan el alcance de entrenar una CNN con pocos datos reales y motivan la comparación con modelos de visión y lenguaje mediante aprendizaje en contexto. El protocolo VLM/ICL se define con Gemma 4 y MedGemma, usando las mismas imágenes, particiones y presupuestos \(K\), como extensión reproducible del marco de evaluación.
