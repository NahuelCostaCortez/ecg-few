...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.42\textwidth}
    \centering
    \safeincludegraphics[width=\textwidth]{results/vlm_huca_v1_normal_k16_confusion_matrix.png}
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \caption{F1.}
  \end{subfigure}
  \caption{Comparación gráfica entre CNN base, ICL normal e ICL balanceado con los datos reales del HUCA y contexto real para Gemma~4.}
