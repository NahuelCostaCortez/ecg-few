...
La etiqueta T\_WAVE\_INVERSION expresa por tanto una propiedad visual localizada. No determina si la inversión es primaria, secundaria, fisiológica o patológica. Esta limitación se conserva al evaluar con datos reales.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{0.19\textwidth} >{\raggedright\arraybackslash}p{0.34\textwidth} X}
    ...
    \bottomrule
  \end{tabularx}
  \caption{Relación entre el concepto clínico y la traducción experimental utilizada en el proyecto}
